...
Repositorio documental para aprender a crear una tienda online real con Pantheon, WordPress, WooCommerce, Astra y Elementor, con apoyo de IA.
...
La documentación combina:

- conceptos y fundamentos necesarios para entender un ecommerce en WordPress
- guías paso a paso para construir una tienda con Pantheon, WordPress, WooCommerce, Astra y Elementor
- material de apoyo visual para replicar mejor el resultado

No se comporta solo como una enciclopedia técnica: está pensada para aprender haciendo y terminar con un producto final visible, verificable y útil para el porfolio.

## 📚 Organización del contenido

La documentación está escrita en Markdown para facilitar su tratamiento por herramientas de IA y se organiza siguiendo Diátaxis:

- `tutorials/` → aprendizaje guiado paso a paso
...
El contenido multimedia no está cargado en NotebookLM por limitaciones de tamaño. Cuando haga falta consultar o añadir recursos visuales, debe usarse esta ruta del repositorio:
...
La organización y mantenimiento de la documentación se describe en:
